...
const SiteNavigation = () => {
  ...
  return (
    <nav className='md:py-2 md:h-36 w-full md:px-12 2xl:px-32 mx-auto'>
        ...
        <div className='w-full hidden md:block'>
          <div className='flex items-center justify-between'>
            <motion.div whileHover={{ scale: 1.1 }}>
              <Link href='/'>
                <Image
                  ...
                  width={1025}
                  height={237}
                  className='2xl:w-44 w-36 h-auto'
                />
              </Link>
            </motion.div>
            <div className='flex items-center space-x-6'>
              ...
              <Button className='bg-logo shadow-md hover:opacity-75 hover:bg-logo md:text-lg 2xl:text-2xl'>
                Get Started
              </Button>
            </div>
          </div>
